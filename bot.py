...
API_ID = int(env.get('API_ID','24828197'))
API_HASH = env.get('API_HASH','d36e278e89ebeb900aeda4128d413a77')
...
async def start_handler(c, m):
    ...
    button = [[        
        InlineKeyboardButton('Updates', url='https://t.me/SECRECT_BOT_UPDATES'),
